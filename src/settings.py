...
class Settings:
    def __init__(self):
        ...
        # Width and height for pygame transform scaling.
        self.ship_scale = (30, 48)
        # Bullet
        ...
        # Time between alien spawns in Level 1
        self.alien_min_time, self.alien_max_time = 5000, 8000
        # Time between alien spawns in Level 2
        self.alien_time_2 = random.randint(500, 1000)
        # Time between alien spawns in Level 3
        self.alien_time_3 = random.randint(30, 200)
        # Width and height for pygame transform scaling.
        self.alien_scale = (30, 48)
        # Levels
